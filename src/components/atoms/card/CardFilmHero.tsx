...
const CardFilmHero: FC<FilmCards> = ({ id, title, banner, description, ageRating }) => {
  ...
  return (
    <div className="col-span-full">
      <div
        data-id={id}
        className="relative w-full h-[300px] sm:h-[500px] lg:h-[600px]"
      />
      ...
      <div className="absolute inset-0 w-full h-full bg-gradient-to-t from-background/90 via-background/50 to-transparent z-10" />

      <div className="w-full absolute inset-0 h-full z-20 flex justify-end flex-col px-8 py-8 sm:py-10 lg:py-16 sm:px-10 lg:px-16">
        ...
        <div className="w-full flex">
          ...
          <div className="flex items-end">
            <BtnPrimary
              ...
              icon={volume ? VolumeOff : VolumeOn}
              onClick={audio}
            />
          </div>
        </div>
